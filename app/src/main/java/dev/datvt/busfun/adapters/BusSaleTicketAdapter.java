 ...
 */
public class BusSaleTicketAdapter extends BaseAdapter {

    private Activity context;
    private List<BusStation> busList;
    private int mLastPosition;

    public BusSaleTicketAdapter(Activity context, List<BusStation> busList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.bus_name.setTextColor(context.getResources().getColor(R.color.color_orange));
        holder.imageView.setImageResource(R.drawable.icon_bus_ticket);
